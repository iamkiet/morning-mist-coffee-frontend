        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-xl mb-16 md:mb-24">
          ...
          <div className="md:col-span-4 flex flex-col space-y-6">
            ...
            <p className="text-base text-muted-foreground font-light leading-relaxed">
              An exploration of sensory precision. Crafting stillness through artisanal coffee and ceramics.
            </p>
          ...
          <div className="md:col-span-3">
            <h5 className="text-xs text-primary tracking-[0.2em] uppercase mb-8 font-medium">Explore</h5>
          ...
          <div className="md:col-span-2">
            <h5 className="text-xs text-primary tracking-[0.2em] uppercase mb-8 font-medium">Locations</h5>
            <div className="flex flex-col space-y-6">
              <div>
                <p className="text-[11px] uppercase tracking-[0.1em] text-foreground mb-1">Portland</p>
                <p className="text-sm text-muted-foreground font-light leading-relaxed">412 NW 13th Ave<br />Oregon, USA</p>
              </div>
              <div>
                <p className="text-[11px] uppercase tracking-[0.1em] text-foreground mb-1">Kyoto</p>
                <p className="text-sm text-muted-foreground font-light leading-relaxed">23-1 Nakagyo-ku<br />Kyoto, Japan</p>
              </div>
            </div>
          </div>
          ...
          {/* Inquiries — col 3 */}
          <div className="md:col-span-3">
            <h5 className="text-xs text-primary tracking-[0.2em] uppercase mb-8 font-medium">Inquiries</h5>
            <div className="flex flex-col space-y-4">
              <a href="mailto:hello@morningmist.coffee"
                className="text-base text-muted-foreground hover:text-primary transition-colors font-light">
                hello@morningmist.coffee
              </a>
              <p className="text-base text-muted-foreground font-light">+1 234 567 890</p>
              <div className="pt-2">
                <p className="text-[11px] uppercase tracking-widest text-muted-foreground/70 leading-relaxed">
                  Support Hours:<br />Mon—Fri 9am—5pm PST
                </p>
              </div>
            </div>
          </div>
